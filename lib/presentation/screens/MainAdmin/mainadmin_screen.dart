      ...
      body: Align(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(user.image ?? '', style: const TextStyle(fontSize: 24)),
            Text(user.password ?? '', style: const TextStyle(fontSize: 24)),
            Text(user.role.toString(), style: const TextStyle(fontSize: 24)),
          ],
        ),
      ),
    );
