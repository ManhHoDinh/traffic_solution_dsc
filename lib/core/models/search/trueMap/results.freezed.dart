...
class _$_Results with DiagnosticableTreeMixin implements _Results {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Results(id: $id, name: $name, address: $address, phoneNumber: $phoneNumber, website: $website, location: $location, types: $types)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, address, phoneNumber,
      website, location, const DeepCollectionEquality().hash(_types));
...
abstract class _Results implements Results {
  const factory _Results(
      ...
      @JsonKey(name: 'types') final List<String>? types}) = _$_Results;
